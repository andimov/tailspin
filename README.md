...
On the home page, filter the catalog by one or more categories and/or a publisher. Category selections match any selected category, and filters update the pre-rendered game cards immediately in the browser.
